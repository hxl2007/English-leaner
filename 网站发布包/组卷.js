...
export const 兑换物品 = [
  {编号:'功法-凡人',类别:'功法',名称:'《静心诀》',境界:'凡人',价格:20,战力:10,说明:'凝神静气，修炼基础心法。'},
  {编号:'功法-练气',类别:'功法',名称:'《青木引气诀》',境界:'练气期',价格:80,战力:35,说明:'引气入体，提升基础战力。'},
  {编号:'功法-筑基',类别:'功法',名称:'《厚土筑基篇》',境界:'筑基期',价格:180,战力:80,说明:'稳固根基，增强耐力。'},
  {编号:'功法-金丹',类别:'功法',名称:'《金丹照心经》',境界:'金丹期',价格:420,战力:160,说明:'心神合一，洞察题意。'},
  {编号:'功法-元婴',类别:'功法',名称:'《紫府元婴录》',境界:'元婴期',价格:800,战力:280,说明:'神识凝练，提升综合战力。'},
  {编号:'功法-化神',类别:'功法',名称:'《化神悟道篇》',境界:'化神期',价格:1400,战力:450,说明:'悟性大增，学习效率提升。'},
  {编号:'功法-炼虚',类别:'功法',名称:'《炼虚周天功》',境界:'炼虚期',价格:2400,战力:700,说明:'周天运转，稳步突破。'},
  {编号:'功法-合体',类别:'功法',名称:'《合体归元诀》',境界:'合体期',价格:3800,战力:1000,说明:'身心合一，战力更上一层。'},
  {编号:'功法-大乘',类别:'功法',名称:'《大乘通明经》',境界:'大乘期',价格:5600,战力:1500,说明:'通明万理，完成最终修行。'},
  {编号:'装备-护腕',类别:'装备',名称:'青藤护腕',价格:45,战力:25,说明:'答题时保持稳定节奏。'},
  {编号:'装备-书袋',类别:'装备',名称:'百纳书袋',价格:120,战力:70,说明:'收纳错题与学习心得。'},
  {编号:'法器-笔',类别:'法器',名称:'明悟灵笔',价格:260,战力:150,说明:'书写翻译时思路更清晰。'},
  {编号:'法器-镜',类别:'法器',名称:'知微鉴',价格:600,战力:320,说明:'复盘错题，洞察薄弱知识点。'},
  {编号:'丹药-聚气',类别:'丹药',名称:'聚气丹',价格:60,战力:0,说明:'服用后提升一个小段修为。'},
  {编号:'丹药-凝神',类别:'丹药',名称:'凝神丹',价格:180,战力:0,说明:'服用后提升一个小段修为。'},
  {编号:'丹药-破境',类别:'丹药',名称:'破境丹',价格:500,战力:0,说明:'服用后提升一个小段修为。'}
];
export const 修为等级 = [
...
export function 通用评分(练习,答案) {
  ...
  return {分数,满分,金币:奖励金币(练习,分数),单题得分,对错,含自评:练习.单元.some(q=>q.题型==='翻译')};
}
